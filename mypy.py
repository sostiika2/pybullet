...
while True:
    ...
    time.sleep(1./240.)
    # for _ in range(1000):
    #     p.setJointMotorControl2(robotId, left_wheel, p.VELOCITY_CONTROL, targetVelocity=5, force=5)
    #     p.setJointMotorControl2(robotId, right_wheel, p.VELOCITY_CONTROL, targetVelocity=5, force=5)
